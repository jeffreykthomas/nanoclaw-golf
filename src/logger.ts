...
type Logger = {
  debug: (dataOrMsg: LogInput, msg?: string) => void;
  info: (dataOrMsg: LogInput, msg?: string) => void;
  warn: (dataOrMsg: LogInput, msg?: string) => void;
  error: (dataOrMsg: LogInput, msg?: string) => void;
  fatal: (dataOrMsg: LogInput, msg?: string) => void;
...
function createLogger(bindings: Record<string, unknown> = {}): Logger {
  const write =
    (level: Level) =>
    (dataOrMsg: LogInput, msg?: string): void => {
      if (typeof dataOrMsg === 'string') {
